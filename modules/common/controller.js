...
exports.getTimezones = function (data, done) {
    var timezones = [
        {
            _id: 1,
            offset: -12,
        ...
        },
        {
            _id: 26,
            offset: 0,
            name: '[GMT] Casablanca, Monrovia, Reykjavik'
        },
        {
            _id: 27,
            offset: 0,
    ...
    done(null, require('./timezones'));
};

exports.getDateFormats = function (data, done) {
    var formats = [
        {
            _id: 1,
            format: 'MM/dd/yyyy'
...
exports.getTimeFormats = function (data, done) {
    var formats = [
        {
            _id: 1,
            format: 'h:mm a'
...
exports.getCountries = function (data, done) {
    done(null, require('./countries'));
};
